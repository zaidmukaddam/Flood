#!/bin/bash
echo "flood v0.0.1"
echo "Author: Zaid Mukaddam(zaidmukadam)"
echo "Github: https://github.com/zaidmukadam"
echo "===> ABOUT <==="
...
echo "For more information and how to use this tool see https://github.com/zaidmukadam/flood"
echo "===> DISCLAIMER <==="
